    ...
    <article>
      ...
      >
        ...
        <span v-for="data in pagination.links" :key="data">
          <button
            @click.prevent="getTickets(true, data.label)"
      ...
      <div class="mt-12 flex xl:hidden justify-end items-center gap-12">
        ...
        <div class="flex items-center gap-4">
          <figure
            ...
            @click.prevent="getTickets(true, pagePast)"
          ...
          <figure
            ...
            @click.prevent="getTickets(true, pageNext)"
            class="cursor-pointer p-3"
          >
            <img src="../../../assets/images/arrow-right.png" alt="Next" />
          </figure>
...
import DetailTicketComponent from "../Ticket/DetailTicketComponent.vue";
export default {
