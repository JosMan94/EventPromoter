...
export default {
  ...
  mounted() {
    if (this.mesero === null) {
      ...
      this.form.documento = this.mesero.document;
      this.form.celular = this.mesero.cellphone;
      this.form.nombre = this.mesero.name;
      this.form.alias = this.mesero.alias;
      this.form.fecha = this.mesero.date_of_birth;
      this.form.email = this.mesero.email;
      this.form.avatar = this.mesero.avatar;
      this.form.pin = this.mesero.pin;

      this.form.regalo_type_1 = this.mesero.regalo_type_1 === 0 ? false : true;
      this.form.regalo_type_2 = this.mesero.regalo_type_2 === 0 ? false : true;
      this.form.entrada_ticket = this.mesero.entrada_ticket === 0 ? false : true;

      this.updocumento = this.mesero.document;
      this.upCelular = this.mesero.cellphone;
      this.upAlias = this.mesero.alias;
      this.upEmail = this.mesero.email;
      this.upAvatar = this.mesero.avatar;
      this.upPin = this.mesero.pin;
    }
  },
  methods: {
    previewImage(e) {
    ...
    async UpdateMesero() {
      ...
      if (result.success) {
        ...
        this.$store.state.alert.text = "Mesero actualizado";

        this.$router.push({
          name: "Administrador",
          params: { viewAdmin: "meseros" },
        });
      } else {
        this.$store.state.alert.status = true;
