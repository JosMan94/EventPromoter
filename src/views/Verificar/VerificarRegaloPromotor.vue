...
export default {
  ...
  methods: {
    ...
    async verifyRegaloForUser() {
      ...
      if (result.success) {
        if (result.message === 1) {
          this.typeVerify = "Ya fue reclamado este regalo";
          this.verify = 2;
        } else if (result.message === 2) {
          this.typeVerify = "Puede reclamar este regalo";
          this.verify = 1;
          this.promotorData.dni = result.user.document;
          this.promotorData.name = result.user.name;
        }
